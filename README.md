...
- `1.4.112/CloudAppRobot`
- `1.4.111/CloudAppRobot`

Recommended use:

1. Prefer `1.4.112/CloudAppRobot` for robot deployment, or fall back to `1.4.111/CloudAppRobot` only when you need the previous baseline.
