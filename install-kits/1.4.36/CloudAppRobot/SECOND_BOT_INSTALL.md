...
This guide is for installing a second Windows robot on a new machine based on the `1.4.30` baseline.
...
5. Backend `bot_version` and `runtime_bot_version` report `1.4.30`.
